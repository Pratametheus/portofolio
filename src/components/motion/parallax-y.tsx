 ...
 * depth cue, capped at the motion vocabulary's travel budget.
 * SSR / no-JS / reduced-motion render the same wrapper with no
...
export function ParallaxY({
  ...
  // Stable structure. The MotionValue attaches only once motion
